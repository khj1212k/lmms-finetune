...
TRAIN_DATA_PATH=./example_data/msmt17_train_small.jsonl  # path to the training data json file
EVAL_DATA_PATH=./example_data/msmt17_val_small.jsonl    # path to the evaluation data json file (optional)
...
RUN_ID=${NUM_GPUS}gpu_${NUM_EPOCHS}epo_${PER_DEVICE_BATCH_SIZE}b_${MODEL_ID}_${TRAIN_DATA_PATH}_lora-${USE_LORA}_qlora-${Q_LORA}_visionlora-${USE_VISION_LORA}     # a custom run id that determines the checkpoint folder and wandb run name
